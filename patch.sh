...
curl https://raw.githubusercontent.com/vlast3k/spring-security-patch/master/cloudfoundry-identity-server-4.24.0-strict.jar -o /var/vcap/data/uaa/tomcat/webapps/ROOT/WEB-INF/lib/cloudfoundry-identity-server-4.24.0.jar
...
curl https://raw.githubusercontent.com/vlast3k/spring-security-patch/825978b57c4dd85dc4bfb07c9c04a1bada760c18/server.xml -o /var/vcap/data/uaa/tomcat/conf/server.xml  
